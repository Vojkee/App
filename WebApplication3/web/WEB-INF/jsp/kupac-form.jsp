...
<body>
	...
	<div id="container">
		...
		<form:form action="savekupac" modelAttribute="kupac" method="POST">
                    <form:hidden path="id" />
			<table>
				<tbody>
					<tr>
						<td><label>IMEE:</label></td>
						<td><form:input path="ime" /></td>
					</tr>
				
					<tr>
						<td><label>PREZIMEE:</label></td>
		...
		<p>
			<a href="${pageContext.request.contextPath}/kupci">Back to List</a>
		</p>
